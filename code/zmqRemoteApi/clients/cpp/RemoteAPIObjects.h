...
namespace RemoteAPIObject
{
    ...
    public:
        ...
        void setShapeInertia(int64_t shapeHandle, std::vector<double> inertiaMatrix, std::vector<double> transformationMatrix);
        ...
        int64_t setThreadAutomaticSwitch(bool automaticSwitch);
        int64_t setThreadSwitchAllowed(bool allowed);
        void setThreadSwitchTiming(int64_t dtInMs);
